...
<img width="396" height="188" alt="image" src="https://github.com/user-attachments/assets/51f66b76-a6e1-4b4e-93cb-264ae0dd58b7" />
...
To build and run a local instance of the website, run `npm start`. To build the website without launching, run `npm run build`.
...
The files in the `_site` folder are to be uploaded to the host.
